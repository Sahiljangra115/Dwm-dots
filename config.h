...
static const char col_gray1[] = "#1E1E3E";  // Deep Space Blue
static const char col_gray2[] = "#9C27B0";  // Electric Purple
static const char col_gray3[] = "#FFFFFF";  // Bright White
static const char col_gray4[] = "#00FFA3";  // Neon Mint
static const char col_cyan[]  = "#1E1E3E";  // Deep Space Blue
...
// Launch Zen Browser (Alt + z)
{ MODKEY,                       XK_z,      spawn,          SHCMD("zen-browser") },
// Launch Nautilus (Alt + e)
{ MODKEY,                       XK_e,      spawn,          SHCMD("nautilus") },
// Launch Terminal (Alt + space)
{ MODKEY,                       XK_space,  spawn,          SHCMD("st") }, // replace "st" with your terminal if it's different
